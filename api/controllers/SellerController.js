/**
 * Api/SellerController.js
 *
 * @description :: Server-side logic for managing seller endpoints
...
module.exports = {
  ...
  async find(req, res) {
    try {
      ...
      const attributes = Object.keys(Seller.sequelize.models.Seller.rawAttributes);
